...
import kotlinx.android.synthetic.main.fragment_friends_new.*
import javax.inject.Inject

class FriendsNewFragment : BaseFragment() {
    ...
    override fun getLayoutId() = R.layout.fragment_friends_new
    ...
    companion object {
        fun newInstance() = FriendsNewFragment()
    }
}